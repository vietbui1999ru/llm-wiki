...
description: "Core doctrine for designing and building mobile UIs. The central law: mobile is not a small desktop. Constraints come first, aesthetics second. Touch-first,…"
---
...
- [Frontend Patterns](/patterns/frontend) — React component patterns, rendering strategies, CSS architecture
- [OWASP Security Checklist](/concepts/owasp-security-checklist) — mobile security intersects with token storage and input validation
- [SpotMe](/entities/spotme) — mobile skill scaffold via React Native skills (Vercel)
