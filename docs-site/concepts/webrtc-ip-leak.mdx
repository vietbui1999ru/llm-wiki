...
description: "WebRTC IP leak is the exposure of a browser's real public IP address through the WebRTC API, even when an HTTP or SOCKS4 proxy is correctly configured. It is…"
---
