---
title: "OpenAI Codex"
description: "OpenAI's AI coding CLI. Pioneered the AGENTS.md format. Has a richer native extension model than the AGENTS.md standard alone: TOML custom agents, native ski…"
---
...
See [Claude Code → Cross-Platform Migration Matrix](/comparisons/cc-to-cross-platform-migration) for full matrix.

---

## Related Pages

- [AGENTS.md (format)](/entities/agents-md-format) — AGENTS.md cross-tool compatibility
- [Claude Code → Cross-Platform Migration Matrix](/comparisons/cc-to-cross-platform-migration) — full migration matrix
- [Agent Subagents](/concepts/agent-subagents) — CC subagent model for comparison
- [Agent Skills](/concepts/agent-skills) — CC skills model for comparison
