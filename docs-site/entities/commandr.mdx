...
- [Builder.io Patterns for Commandr + DiffViewer](/syntheses/builderio-control-plane-integration) defines the concrete action/artifact mapping: live SPEC actions go through `bin/` tools; visual plans/recaps stay DiffViewer-local until a conformance-backed artifact event exists.
