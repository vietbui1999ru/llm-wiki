...
The concrete integration contract is [Builder.io Patterns for Commandr + DiffViewer](/syntheses/builderio-control-plane-integration): DiffViewer implements a local action dispatcher and writes regenerable artifacts under `.diffviewer/artifacts/<task>/`, while Commandr lifecycle mutations still go through SPEC-defined `bin/` tools and event types.
...
- [Builder.io Patterns for Commandr + DiffViewer](/syntheses/builderio-control-plane-integration) — concrete Builder.io action/artifact integration plan
