---
title: "Docling"
description: "Open-source document parsing library from IBM Research Zurich. Converts PDFs and other document formats into structured representations suitable for RAG pipe…"
---
...
Complementary: Firecrawl for web, Docling for files. See [Firecrawl](/entities/firecrawl).
...
Combined with [Contextual Retrieval](/concepts/contextual-retrieval) (prepend context to chunks before embedding), Docling-quality parsing maximizes retrieval precision.

## Relation to other tools

- Complements [Firecrawl](/entities/firecrawl): Firecrawl handles web URLs; Docling handles files and PDFs
- Works upstream of [Contextual Retrieval](/concepts/contextual-retrieval): clean Docling output → better chunk context → better retrieval
