---
title: "omp (oh-my-pi)"
description: "Fork of badlogic/pi-mono by can1357. Positions itself as the batteries-included coding agent: same TypeScript + TUI shell as Pi, but with a ~55k-line Rust na…"
---
...
- [Pi Agent (pi-mono)](/entities/pi-agent) — upstream fork; minimal harness design; Terminal Bench data
- Omp Oh My Pi — full source summary
- [Our Stack vs omp](/comparisons/our-stack-vs-omp) — feature gap vs our Claude Code + Pi setup
- [Commandr](/entities/commandr) — L3 bus omp should speak through
- [DiffViewer](/entities/diffviewer) — L5 UI consuming omp artifacts through Commandr/DiffViewer sidecars
- [Agent Harness](/concepts/agent-harness) — harness engineering framing
- [Claude Code vs OpenCode Plugin Systems](/comparisons/claude-code-vs-opencode-plugins) — adjacent harness comparison
