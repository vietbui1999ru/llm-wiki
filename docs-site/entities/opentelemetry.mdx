---
title: "OpenTelemetry"
description: "CNCF-graduated open-source observability framework for distributed systems. Provides a vendor-neutral standard for collecting and exporting traces, metrics,…"
---
...
- [LLM Observability](/concepts/llm-observability) — full observability patterns for LLM and agent systems
- [Agent Harness](/concepts/agent-harness) — orchestration systems where OTel trace correlation matters
- [Context Degradation Patterns](/concepts/context-degradation) — failure modes that OTel helps diagnose
