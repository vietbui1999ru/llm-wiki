...
- [omp (oh-my-pi)](/entities/omp) informs **L2 execution quality**: use high-quality runners for edits, LSP/DAP, subagents, and tool schemas; do not let a runner own lifecycle state.
