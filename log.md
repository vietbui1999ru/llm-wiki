...
## [2026-06-19] research | GLM-5.2 as Opus-tier orchestrator

Source: r/opencodeCLI thread (raw/claude-runaway-tried-kimi-2-6-and-deepseek-v4-5y-fullstack-dev.md)

Findings:
- GLM-5.2 community niche is sequential plan file generation, NOT general orchestration
- DeepSeek V4 Pro > GLM-5.2 for issue analysis in head-to-head
...
- Model ID opencode-go/glm-5.2 still unconfirmed in any config
