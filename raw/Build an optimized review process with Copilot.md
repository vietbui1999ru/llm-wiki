...
2. To enable automatic Copilot code review for your repository, see [Configuring automatic code review by GitHub Copilot](https://docs.github.com/en/copilot/how-tos/copilot-on-github/set-up-copilot/configure-automatic-review).
3. To configure Copilot Autofix for your repo you'll need to enable code scanning. Once code scanning with CodeQL analysis is enabled, Copilot Autofix is enabled by default. For the easiest setup, see [Configuring default setup for code scanning](https://docs.github.com/en/code-security/code-scanning/enabling-code-scanning/configuring-default-setup-for-code-scanning).
