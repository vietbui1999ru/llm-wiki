...
Used in: [[entities/qmd]], [[concepts/contextual-retrieval]], most production RAG pipelines.

## Related

- [[concepts/contextual-retrieval]] — adds document context to BM25 index entries to reduce context-stripping failures
- [[entities/qmd]] — local search engine using BM25 + vector hybrid
